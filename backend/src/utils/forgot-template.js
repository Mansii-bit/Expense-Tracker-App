          ...
          <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="max-width:600px;width:100%;background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 6px rgba(0,0,0,0.08);">
            ...
            <tr>
              <td style="padding:20px 24px;text-align:center;background:#ffffff;">
                <!-- If you have a logo -->
                <img src="https://plus.unsplash.com/premium_photo-1681487746049-c39357159f69?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Expense" width="120" style="max-width:120px;height:auto;border:0;display:block;margin:0 auto 8px;" />
